...
class ALBCleanupManager:
    ...
    def cleanup_vp_alb_resources(self, vp_id: str, listener_arn: str) -> bool:
        ...
        try:
            ...
            if success:
                ...
                logger.warning(
                    f"Partial cleanup for VP {vp_id} - Rule: {rule_deleted}, TG: {tg_deleted}"
                )
    ...
    def _find_listener_rule(self, listener_arn: str, vp_id: str) -> Optional[str]:
        ...
        try:
            ...
            for rule in response["Rules"]:
                ...
                try:
                    tags_response = self.elbv2_client.describe_tags(ResourceArns=[rule_arn])
    ...
    def _delete_listener_rule(self, rule_arn: str) -> bool:
        ...
        try:
            ...
            self.elbv2_client.delete_rule(RuleArn=rule_arn)
            ...
            try:
                ...
                if health_response["TargetHealthDescriptions"]:
                    ...
                    if targets:
                        ...
                        self.elbv2_client.deregister_targets(TargetGroupArn=tg_arn, Targets=targets)
                        logger.info("Targets deregistered successfully")

            except Exception as e:
                logger.warning(
                    f"Error deregistering targets (may already be deregistered): {str(e)}"
                )

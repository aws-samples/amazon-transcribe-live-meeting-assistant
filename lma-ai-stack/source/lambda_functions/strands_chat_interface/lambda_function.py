...
def lambda_handler(event, context):
    ...
    try:
        ...
        logger.info(
            f"STRANDS Chat Interface - Invoking AsyncAgentAssistOrchestrator: {orchestrator_arn}"
        )
        ...
        logger.info(
            "STRANDS Chat Interface - AsyncAgentAssistOrchestrator invoked successfully (async)"
        )

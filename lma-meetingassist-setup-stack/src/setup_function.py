...
def setupQnABot(props, oldprops):
  ...
  if propsChanged(props, oldprops, ["QNABOTSTACK", "QnaMeetingAssistDemoJson", "QNASummarizeCallFunction", "QNAQBusinessFunction"]):
...
def loadQnABotSamplePackage(props):
  ...
  filedata = re.sub('<QNAQBusinessFunctionName>', props["QNAQBusinessFunction"], filedata)

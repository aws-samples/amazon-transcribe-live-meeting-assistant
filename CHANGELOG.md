...
- **Virtual Participant "LMA end" chat command reliably ends the meeting** — The end command no longer hangs; the VP posts its goodbye (best-effort, time-bounded) and leaves.

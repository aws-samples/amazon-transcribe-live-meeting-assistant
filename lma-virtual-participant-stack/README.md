...
Using the Virtual Participant is an alternative to using the LMA Stream Audio tab to capture your meeting.

Advantages:

- By using the Virtual Participant instead of Stream Audio, you are free to use the native Chime, or Zoom app on your desktop rather than being compelled to running the meeting in your browser.
